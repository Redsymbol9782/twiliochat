...
@section('content')
  ...
  <div class="container-fluid">
    ...
    <!-- JavaScript -->
    <script src="{{ asset('public/js/jquery-throttle.min.js') }}"></script>
    <script src="{{ asset('public/js/jquery.loadTemplate-1.4.4.min.js') }}"></script>
    ...
    <script src="{{ asset('public/js/twiliochat.js') }}"></script>
