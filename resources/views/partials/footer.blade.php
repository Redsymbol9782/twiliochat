<footer class="main-footer">
    ...
    <strong>Copyright &copy; {{date('Y')}} <a href="{{URL::asset('/')}}">Twilio IVR</a>.</strong> All rights
    reserved.
</footer>
    ...
    <div class="tab-content">
		...
		<div class="tab-pane" id="control-sidebar-home-tab">
			...
			<ul class="control-sidebar-menu">
				<li>
					<a href="javascript:void(0)">
						<h4 class="control-sidebar-subheading">Custom Template <span class="label label-danger pull-right">70%</span></h4>
